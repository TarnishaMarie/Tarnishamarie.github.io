...
(function($, doc, win, Snap) {
  ...
  Donut.prototype.drawLegend = function() {
    ...
    var x = o.center.x + o.radius + 50,
      ...
      radius = 10,
      y =
        o.center.y - data.length / 2 * step + radius / 2 + (step - radius) / 2;
  ...
  Donut.prototype.initInteraction = function(d, step) {
    ...
    l.button = s.rect(
      l.center.x - 2 * l.baseCircleRadius,
      l.center.y - step / 2,
      200,
      step
    );
  ...
  Donut.prototype.startShowAnimation = function(index, totalPct, callback) {
    ...
    if (data.length > i) {
      var d = data[i];
      this.startShowAnimationOneEntry(
        d,
        total,
        total + d.value,
        o.center,
